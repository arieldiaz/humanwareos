...
2. Confirm the survey title, introduction, confirmation message, and ordered questions. Use text, paragraph, multipleChoice, checkbox, or scale; include choices or scale bounds where required. Done when the tool input is complete and contains no private credential material.
