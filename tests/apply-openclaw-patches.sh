...
touch "$TMP/patches/patch-2026.7.1-prompt-boilerplate.mjs" "$TMP/patches/patch-2026.7.1-slack-rich-text.mjs" "$TMP/patches/patch-2026.9.1-manual-cancel-notify.mjs" "$TMP/patches/patch-2026.9.1-slack-response-reliability.mjs"
...
test "$(sed -n '3p' "$TMP/modern.log")" = "patch-2026.9.1-manual-cancel-notify.mjs"
test "$(sed -n '4p' "$TMP/modern.log")" = "patch-2026.9.1-slack-response-reliability.mjs"
test "$(wc -l < "$TMP/modern.log" | tr -d ' ')" = "4"
