...
touch "$TMP/patches/patch-2026.7.1-prompt-boilerplate.mjs" "$TMP/patches/patch-2026.7.1-slack-rich-text.mjs" "$TMP/patches/patch-2026.9.1-manual-cancel-notify.mjs"
...
test "$(wc -l < "$TMP/modern.log" | tr -d ' ')" = "3"
