...
export function renderAgentContext({agentId, frameworkRules, instanceRules, agentTemplate, agentOverlay, runtimeCurrent, dataRoot}) {
  ...
  return {
    ...
    "STRATEGY.md": `# STRATEGY.md — data-plane bridge\n\nCurrent strategy lives at ${join(dataRoot, "current", "strategy.md")}. Load that canonical projection before non-trivial work when the execution profile's data scope permits it. This generated bridge contains no copied strategy facts.\n`,
  };
}
